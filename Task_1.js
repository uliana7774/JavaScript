...
users.forEach(function(array_item_1) {
if (array_item_1.registrationDate == '09.10.2021')
    console.log(array_item_1.firstName, array_item_1.lastName)
})
users.forEach(function(array_item_2) {
if (array_item_2.registrationDate == '10.10.2021')
    console.log(array_item_2.firstName, array_item_2.lastName)
})